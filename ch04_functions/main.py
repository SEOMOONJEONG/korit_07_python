...
2. 메서드(methods) : 특정 객체가 가지고 있는 함수의 의미. 특정 자료형에 포함되어있는 함수. 사실 함수와 메서드는 동일한 개념이지만, 호출 방식에 있어서의 차이가 있습니다.
...
# 예제
'''
700원짜리 음료수를 뽑을 수 있는 자판기 프로그램을 구현하시오. 
돈을 넣으면 몇 잔의 음료수를 뽑을 수 있는지, 그리고 잔돈은 얼마인지 모든 경우의 수를 출력하도록 합니다.
...
// : 몫 연산자 몫만 int로 가지고 오는거
'''

# def vending_machine(money):
#     drink = 700
#     num = 0
#     while money > drink * num :
#         print(f'음료수 = {num}개, 잔돈 = {int(money) - drink * num}원')
#         num += 1
#
# vending_machine(3000)
...
#         print(f'음료수 = {num}개, 잔돈 = {my_money -(drink_price*i)}원')
#
# vending_machine(3000)
#
...
#         if change < 0:
#             break
#         print(f'음료수 개수 = {i}개, 잔돈 = {change}원')
#         i += 1
...
#
# def multiply(n):
#     for i in range(1, 10):                      # in range() 부분 신경 써야 하는데
#         print(f'{dan} x {i} = {dan * i}')
#
# multiply(dan)
