...
no = int(input('몇 개의 숫자를 입력하시겠습니까? >>> '))
...
for i in range(no):
    ...
    if num > 0:
        num_list_p.append(num)
    elif num < 0:
        num_list_m.append(num)
    else:
        num_list_z.append(num)

print(f'양수 : {len(num_list_p)}개')
print(f'음수 : {len(num_list_m)}개')
print(f'0 : {len(num_list_z)}개')
